# Flutter SDK（Flutter 軟體開發套件）總覽

> Flutter 函式庫與命令列工具。



Flutter SDK（Flutter 軟體開發套件）包含了開發跨平台 Flutter 應用程式所需的套件與命令列工具。若要取得 Flutter SDK，請參閱 [Install][]。
...
* [Flutter DevTools][]，可用於測試、除錯與效能分析您的應用程式
* `flutter` 與 `dart` 命令列工具，用於建立、建置、測試及編譯您的應用程式

注意：如需更多有關 Flutter SDK 的資訊，請參閱其 [README file][]。
...
[`dart` CLI tool]: https://dart.dev/tools/dart-tool
[`flutter` CLI tool]: /reference/flutter-cli
[Install]: /install
[README file]: https://github.com/flutter/flutter/blob/main/README.md
