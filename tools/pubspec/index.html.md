...
> 說明 pubspec 檔案中僅限 Flutter 使用的欄位。
...
[Dart's pubspec supported fields]: https://dart.dev/tools/pub/pubspec#supported-fields
...
> 注意：此功能僅自
> [#167953](https://github.com/flutter/flutter/pull/167953) 起於 `main`
> 頻道提供。
...
> 注意：自從 [#168433](https://github.com/flutter/flutter/pull/168433) 在 `main` 頻道之後，此屬性已移至 [`config`](#config) 區段：
>
> ```yaml title="pubspec.yaml"
> flutter:
>   config:
...
[Glossary of package terms]: https://dart.dev/tools/pub/glossary
[Package dependencies]: https://dart.dev/tools/pub/dependencies
[Using packages]: /packages-and-plugins/using-packages
[What not to commit]: https://dart.dev/guides/libraries/private-files#pubspeclock
