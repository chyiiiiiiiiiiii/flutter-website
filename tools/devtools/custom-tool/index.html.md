# 在 Flutter 和 Dart DevTools 中建置自訂工具
...
[`package:devtools_app_shared`]: https://pub.dev/packages/devtools_app_shared
...
[`path`]: https://dart.dev/tools/pub/dependencies#path-packages
</li>
...
[publishing guide]: https://pub.dev/packages/devtools_extensions#publish-your-package-with-a-devtools-extension
...
[Flutter Discord server]: https://github.com/flutter/flutter/wiki/Chat
