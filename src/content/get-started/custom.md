...
如果您打算使用 VS Code 或其他以 Code - OSS 為基礎的編輯器，
...
常見選項包括 VS Code、Android Studio、
Firebase Studio 以及其他基於 Code OSS 的編輯器。
...
<div class="card-grid wide">
 ...
 <a class="card outlined-card" href="https://studio.firebase.google.com/new/flutter" target="_blank">
   ...
   <div class="card-content">
     <p>在 Firebase Studio 建立新的 Flutter 工作區。</p>
   </div>
 </a>
</div>
...
我們建議您優先[開發 Web 平台][web-setup]{: target="_blank"}，
...
請參考 [建立您的第一個應用程式][Building your first app] 的 Codelab，
