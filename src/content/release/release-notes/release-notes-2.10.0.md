...
本頁為 2.10.0 版本的發行說明。
關於後續的錯誤修正版本資訊，請參閱我們的 [CHANGELOG][CHANGELOG]

[CHANGELOG]: https://github.com/flutter/flutter/blob/master/CHANGELOG.md

## 依標籤彙整的已合併 PR（`flutter/flutter`）




#### waiting for tree to go green - 共 526 個 Pull Request
...
[77103](https://github.com/flutter/flutter/pull/77103) [web] 允許在不使用條件匯入的情況下使用 url 策略（cla: yes、f: routes、platform-web、waiting for tree to go green）
...
[87643](https://github.com/flutter/flutter/pull/87643) 更新 IconButton.iconSize 以從主題取得值（framework、f: material design、cla: yes、waiting for tree to go green）

[88508](https://github.com/flutter/flutter/pull/88508) 修正同時用兩根手指拖曳 ReorderableListView 不會當機（framework、f: material design、cla: yes、waiting for tree to go green）

[89045](https://github.com/flutter/flutter/pull/89045) feat: 在 test 指令啟用 flavor 選項（tool、cla: yes、waiting for tree to go green）

[90178](https://github.com/flutter/flutter/pull/90178) 更新 scrollbar，支援即使未 hover 也能總是顯示軌道（framework、f: material design、cla: yes、waiting for tree to go green）

[90461](https://github.com/flutter/flutter/pull/90461) 修正 zero route transition duration 當機問題（framework、cla: yes、waiting for tree to go green）

[90608](https://github.com/flutter/flutter/pull/90608) RangeMaintainingScrollPhysics 移除 grow 時的 overscroll 維持（framework、f: scrolling、cla: yes、waiting for tree to go green）

[90684](https://github.com/flutter/flutter/pull/90684) 移動 text editing `Action`s 至 `EditableTextState`（team、framework、f: material design、cla: yes、f: cupertino、d: examples、waiting for tree to go green）

[90932](https://github.com/flutter/flutter/pull/90932) showBottomSheet 公開 enableDrag 屬性（framework、f: material design、cla: yes、waiting for tree to go green、will affect goldens）
...
[91698](https://github.com/flutter/flutter/pull/91698) 修正文字游標或輸入可超出文字欄位範圍（a: text input、framework、cla: yes、waiting for tree to go green、will affect goldens）
...
[92031](https://github.com/flutter/flutter/pull/92031) 新增工具警告日誌等級與命令列選項，可在警告/錯誤輸出時失敗（team、tool、cla: yes、waiting for tree to go green）

[92160](https://github.com/flutter/flutter/pull/92160) 新增 `expandedScale` 至 `FlexibleSpaceBar`（framework、f: material design、cla: yes、waiting for tree to go green）
...
[92197](https://github.com/flutter/flutter/pull/92197) 再次移除 BottomNavigationBarItem.title 的棄用（framework、f: material design、cla: yes、f: cupertino、waiting for tree to go green）
...
[92440](https://github.com/flutter/flutter/pull/92440) 允許程式化控制 Draggable Sheet（framework、f: scrolling、cla: yes、waiting for tree to go green）

[92451](https://github.com/flutter/flutter/pull/92451) bump Android SDK 版本以符合 plugins 時新增警告（tool、cla: yes、waiting for tree to go green）

[92480](https://github.com/flutter/flutter/pull/92480) [Cupertino] 修正 `ContextMenuAction` 的 dark mode 問題（a: text input、framework、cla: yes、f: cupertino、waiting for tree to go green）

[92535](https://github.com/flutter/flutter/pull/92535) 再次合併："更新 benchmarks 資料夾中的過時 runners (#91126)"（team、tool、cla: yes、waiting for tree to go green、integration_test）

[92615](https://github.com/flutter/flutter/pull/92615) 修正切換新 route 會破壞前一個 FocusNode 的問題（framework、cla: yes、waiting for tree to go green、f: focus）
...
[92657](https://github.com/flutter/flutter/pull/92657) 修正 scrollbar 當機 bug（framework、f: scrolling、cla: yes、waiting for tree to go green）
...
[92738](https://github.com/flutter/flutter/pull/92738) 將 emulators 遷移至 null safety（tool、cla: yes、waiting for tree to go green、a: null-safety、tech-debt）

[92753](https://github.com/flutter/flutter/pull/92753) [gen_l10n] 支援在 select 中新增 placeholder（tool、cla: yes、waiting for tree to go green）
...
[92849](https://github.com/flutter/flutter/pull/92849) 將 tracing 遷移至 null safety（tool、cla: yes、waiting for tree to go green、a: null-safety、tech-debt）
...
[92901](https://github.com/flutter/flutter/pull/92901) 執行或建置時遇到已棄用 v1 embedding 直接結束（team、tool、a: accessibility、cla: yes、waiting for tree to go green、integration_test）
...
[92916](https://github.com/flutter/flutter/pull/92916) Mac_ios platform_view_ios__start_up 標記為非 flaky（cla: yes、waiting for tree to go green）
...
[92924](https://github.com/flutter/flutter/pull/92924) 更新 packages（team、tool、cla: yes、waiting for tree to go green）
...
[92938](https://github.com/flutter/flutter/pull/92938) 原生 macOS 整合測試時跳過 codesigning（team、cla: yes、waiting for tree to go green、integration_test）
...
[92945](https://github.com/flutter/flutter/pull/92945) [TextInput] 切換輸入 client 時，先傳送 `setEditingState` 再傳送 `show` 給 text input plugin（a: text input、framework、cla: yes、waiting for tree to go green）
...
[92950](https://github.com/flutter/flutter/pull/92950) channel、clean 及其他部分指令遷移至 null safety（tool、cla: yes、waiting for tree to go green）

[92952](https://github.com/flutter/flutter/pull/92952) doctor、format 及其他部分指令遷移至 null safety（tool、cla: yes、waiting for tree to go green、a: null-safety、tech-debt）
...
[92970](https://github.com/flutter/flutter/pull/92970) 再次合併 "Refactor ThemeData (#91497)"（第二部分）（framework、f: material design、cla: yes、waiting for tree to go green）

[92975](https://github.com/flutter/flutter/pull/92975) flutter_gen 專案於 "flutter create" 時正確建立（tool、cla: yes、waiting for tree to go green）
...
[92989](https://github.com/flutter/flutter/pull/92989) 停止傳送 metrics 至 builder name（team、cla: yes、waiting for tree to go green、team: benchmark）
...
[93013](https://github.com/flutter/flutter/pull/93013) Linux web_canvaskit_tests_0 標記為非 flaky（team、cla: yes、team: flakes、waiting for tree to go green、tech-debt）

[93014](https://github.com/flutter/flutter/pull/93014) Linux web_canvaskit_tests_1 標記為非 flaky（team、cla: yes、team: flakes、waiting for tree to go green、tech-debt）

[93015](https://github.com/flutter/flutter/pull/93015) Linux web_canvaskit_tests_2 標記為非 flaky（team、cla: yes、team: flakes、waiting for tree to go green、tech-debt）

[93016](https://github.com/flutter/flutter/pull/93016) Linux web_can
