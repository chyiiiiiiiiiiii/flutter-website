---
title: 當啟用 maintainState 時，Visibility 元件（Widget）預設不再可聚焦
description: >-
...
* [PR 159133: 為 Visibility 新增排除隱藏子元件焦點的旗標 maintainFocusability。在 IndexedStack 中將 maintainFocusability 設為 false]({{site.repo.flutter}}/pull/159133)
