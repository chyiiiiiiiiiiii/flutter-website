...
description: >-
  已淘汰的 `.flutter-plugins` 工具檔案輸出已被 `.flutter-plugins-dependencies` 取代，所有建置腳本或相關引用也必須一併更新。
---
...
若要進行 smoke test（冒煙測試），檢查你的建置是否依賴 `.flutter-plugins` 檔案，
...
- [Issue 48918][Issue 48918]，`.flutter-plugins`於 2020 年被列為即將淘汰（deprecated）。

相關 PR：

- [PR 45379][PR 45379]，`.flutter-plugins-dependencies`最初於此新增。
- [PR 157388][PR 157388]，於 Flutter Android 建置腳本中新增了警告。
