...
Flutter Windows 應用程式所建置出的可執行檔，現在會依照架構分類存放於不同的資料夾中。

## 背景

為了支援 Windows on Arm64，Windows 的建置路徑已更新，現在會加入建置時的目標架構。

過去，Flutter 在 Windows 上建置時預設目標架構為 x64。

## 移轉指南

您可能需要更新您的基礎設施，以使用新的 Flutter Windows 建置路徑。
