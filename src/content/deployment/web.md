...
* [建置發佈版本的應用程式](#建置發佈版本的應用程式)
* [部署至 Web](#部署至-web)
* [部署至 Firebase Hosting](#部署至-firebase-hosting)
* [在 Web 上處理圖片](#在-web-上處理圖片)
* [選擇建置模式與渲染器](#選擇建置模式與渲染器)
...
1. 在 [Firebase framework-aware CLI][Firebase framework-aware CLI] 啟用 Web 框架預覽功能：
