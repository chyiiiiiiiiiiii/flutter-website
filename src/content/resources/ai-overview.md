...
title: AI
description: >
  瞭解可用於在您的 Flutter 應用程式中加入生成式 AI 的相關資源。
---
...
只需最少的設定，即可將進階文字生成、摘要、聊天等功能整合到您的 Dart 或 Flutter 應用程式中，並能部署至多個平台。

**全新**的 [Flutter AI Toolkit][Flutter AI Toolkit] 提供如何將 AI 生成聊天機器人整合進 Flutter 應用程式的教學。
**立即查看！**
...
同時，也歡迎參考 Google I/O 2024 的以下影片：
