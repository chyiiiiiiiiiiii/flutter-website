...
1. <h3>檢查工具鏈問題</h3>
   ...
   如果你在 **Windows version** 和 **Visual Studio - develop Windows apps** 區段下看到任何錯誤或待完成的事項，請先完成並解決這些問題，然後再次執行 `flutter doctor -v` 以驗證變更。

1. <h3>檢查 Windows 裝置</h3>

   為確保 Flutter 能正確找到並連接你的 Windows 裝置，請在你偏好的終端機中執行 `flutter devices`：
...
恭喜你！
現在你已完成 Flutter 的 Windows 桌面開發環境設定，
