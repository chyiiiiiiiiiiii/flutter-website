# 適用於應用程式開發者的 Swift Package Manager

> 如何使用 Swift Package Manager 管理原生 iOS 或 macOS 相依套件
...
[file an issue]: https://github.com/flutter/flutter/issues/new?template=02_bug.yml
