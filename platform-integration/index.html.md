...
<div class="card-grid">
  ...
  <a class="card outlined-card" href="/platform-integration/bind-native-code">
    ...
    <div class="card-content">
      <p>學習如何在 Android 上從你的應用程式綁定原生程式碼。</p>
    </div>
  </a>
...
<div class="card-grid">
  ...
  <a class="card outlined-card" href="https://dart.dev/interop/js-interop" target="_blank">
    <div class="card-header">
...
學習如何將自訂整合加入你的 Flutter 應用程式中的 macOS。
...
學習如何將自訂整合加入你的 Flutter 應用程式中的 Linux。
...
<div class="card-grid">
  <a class="card outlined-card" href="/platform-integration/linux/building#integrate-with-linux">
    ...
    <div class="card-content">
      <p>學習如何使用並綁定原生 Linux 函式庫與程式碼。</p>
    </div>
  </a>
  <a class="card outlined-card" href="/platform-integration/linux/building#prepare-linux-apps-for-distribution">
    <div class="card-header">
      <span class="card-title">準備發布</span>
    </div>
    <div class="card-content">
      <p>準備將你的 Flutter 應用程式發布給 Linux 使用者。</p>
    </div>
  </a>
  <a class="card outlined-card" href="/deployment/linux/">
    <div class="card-header">
      <span class="card-title">部署至 Snap Store</span>
    </div>
    <div class="card-content">
      <p>學習如何將你的 Linux 桌面應用程式部署至 Snap Store。</p>
    </div>
  </a>
</div>
