...
* Flutter 對 liquid glass 的支援：[Issue 170310][]
* Flutter 應用程式的眼動追蹤（Eye tracking）：[Issue 153573][]
* Hover typing 功能：[Issue 152715][]
* iOS 格式化選單（formatting menu）：[Issue 150068][]
* iOS 風格的縮放頁面轉場（zoom page transition）：[Issue 150588][]
* iPad 風格的分頁列（tab bar）：[Issue 150590][]
* 在檢視 Flutter 應用程式時的 iPhone 螢幕鏡像（mirroring）：[Issue 152711][]
* 大型內容檢視器（Large content viewer）：[Issue 152715][]
* 在內容編輯選單中新增「翻譯」按鈕：[Issue 150392][]
* 虛擬觸控板（Virtual trackpad）功能：[Issue 152715][]
* Writing tools 文字輸入功能：[Issue 150965][]、[Issue 150452][]
