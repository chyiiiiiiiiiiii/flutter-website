...
[`FirestoreMessageCodec`]: https://github.com/firebase/flutterfire/blob/master/packages/cloud_firestore/cloud_firestore_platform_interface/lib/src/method_channel/utils/firestore_message_codec.dart
[developing packages]: /packages-and-plugins/developing-packages
[Engine Embedder APIs]: https://api.dart.dev/index.html#more-documentation
...
[`/examples/platform_channel/`]: https://github.com/flutter/flutter/tree/main/examples/platform_channel
[`/examples/platform_channel_swift/`]: https://github.com/flutter/flutter/tree/main/examples/platform_channel_swift
[JS interoperability]: https://dart.dev/web/js-interop
...
[`MethodChannel` for Flutter]: https://api.flutter.dev/flutter/services/MethodChannel-class.html
[`MethodChannel` for Android]: https://api.flutter.dev/javadoc/io/flutter/plugin/common/MethodChannel.html
[`FlutterMethodChannel` for iOS]: https://api.flutter.dev/ios-embedder/interface_flutter_method_channel.html
