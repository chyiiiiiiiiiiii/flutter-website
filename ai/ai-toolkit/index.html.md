...
> 了解如何將 AI Toolkit 聊天機器人 加入您的 Flutter 應用程式。
...
[camera]: https://pub.dev/packages/camera#setup
[file]: https://pub.dev/packages/file_selector#usage
[image_picker]: https://pub.dev/packages/image_picker#installation
[record]: https://pub.dev/packages/record#setup-permissions-and-others
</li>
</ol>
