...
[`scriptCode`]: https://api.flutter.dev/flutter/package-intl_locale/Locale/scriptCode.html
...
[language-count]: https://api.flutter.dev/flutter/flutter_localizations/GlobalMaterialLocalizations-class.html
...
[`gen_l10n_example`]: https://github.com/flutter/website/tree/main/examples/internationalization/gen_l10n_example
[`MaterialApp.onGenerateTitle`]: https://api.flutter.dev/flutter/material/MaterialApp/onGenerateTitle.html
...
數字（包括代表貨幣價值的數字）在不同的地區語系（locale）中顯示方式差異很大。`flutter_localizations` 的在地化產生工具會使用 [`NumberFormat`](https://api.flutter.dev/flutter/package-intl_intl/NumberFormat-class.html) 類別（class），該類別屬於 `intl` 套件，用來根據地區語系與所需格式來格式化數字。
...
[`DateFormat`]: https://api.flutter.dev/flutter/package-intl_intl/DateFormat-class.html
...
[`Localizations`]: https://api.flutter.dev/flutter/widgets/WidgetsApp/supportedLocales.html
...
[widgets-global]: https://api.flutter.dev/flutter/flutter_localizations/GlobalWidgetsLocalizations-class.html
...
[`localeResolutionCallback`]: https://api.flutter.dev/flutter/widgets/LocaleResolutionCallback.html
...
[`LocalizationsDelegate`]: https://api.flutter.dev/flutter/widgets/LocalizationsDelegate-class.html
[`Localizations.of(context,type)`]: https://api.flutter.dev/flutter/widgets/Localizations/of.html
...
[an example]: https://github.com/flutter/website/tree/main/examples/internationalization/minimal
...
[`add_language`]: https://github.com/flutter/website/tree/main/examples/internationalization/add_language/lib/main.dart

[flutter_localizations README]: https://github.com/flutter/flutter/blob/main/packages/flutter_localizations/lib/src/l10n/README.md
...
[`SynchronousFuture`]: https://api.flutter.dev/flutter/foundation/SynchronousFuture-class.html
