...
[`CupertinoColors`]: https://api.flutter.dev/flutter/cupertino/CupertinoColors-class.html
...
[Apple's Human Interface Guidelines for iOS]: https://developer.apple.com/design/human-interface-guidelines/designing-for-ios
...
* [Material 應用程式](https://github.com/flutter/website/tree/main/examples/layout/base)
* [非 Material 應用程式](https://github.com/flutter/website/tree/main/examples/layout/non_material)
...
[`pubspec.yaml` file]: https://github.com/flutter/website/tree/main/examples/layout/row_column/pubspec.yaml
...
[sizing]: https://github.com/flutter/website/tree/main/examples/layout/sizing
...
[pubspec file]: https://github.com/flutter/website/tree/main/examples/layout/pavlova/pubspec.yaml
...
[`CupertinoPageScaffold`]: https://api.flutter.dev/flutter/cupertino/CupertinoPageScaffold-class.html
[`CupertinoNavigationBar`]: https://api.flutter.dev/flutter/cupertino/CupertinoNavigationBar-class.html
[`CupertinoSegmentedControl`]: https://api.flutter.dev/flutter/cupertino/CupertinoSegmentedControl-class.html
...
<div>
  ...
  **Dart code:**
  [`grid_list_demo.dart`](https://github.com/flutter/website/tree/main/examples/layout/gallery/lib/grid_list_demo.dart)
</div>
</div>
...
<div>
  ...
  **Dart code:**
  [`colors_demo.dart`](https://github.com/flutter/website/tree/main/examples/layout/gallery/lib/colors_demo.dart)
</div>
</div>
...
[Material 2 Design palette]: https://m2.material.io/design/color/the-color-system.html#tools-for-picking-colors
...
<div>
  ...
  **Dart code:**
  [`bottom_navigation_demo.dart`](https://github.com/flutter/website/tree/main/examples/layout/gallery/lib/bottom_navigation_demo.dart)
</div>
</div>
...
[Material card]: https://m3.material.io/components/cards
[Material library]: https://api.flutter.dev/flutter/material/material-library.html
...
<div>
  ...
  **Dart code:**
  [`cards_demo.dart`](https://github.com/flutter/website/tree/main/examples/layout/gallery/lib/cards_demo.dart)
</div>
</div>
...
<div>
  ...
  **Dart code:**
  [`list_demo.dart`](https://github.com/flutter/website/tree/main/examples/layout/gallery/lib/list_demo.dart)
</div>
</div>
...
[Flutter in Focus 播放清單](https://www.youtube.com/playlist?list=PLjxrf2q8roU2HdJQDjJzOeO6J3FoFLWr2)
...
[Flutter Widget of the Week 播放清單](https://www.youtube.com/playlist?list=PLjxrf2q8roU23XGwz3Km7sQZFTdB996iG)
