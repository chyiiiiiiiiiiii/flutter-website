# Flutter 中的 Material 3 標記（tokens）更新

> 最新的 Material Design 3 標記（v6.1）已套用至 Flutter 的 Material 函式庫。
...
[Update tokens to v5.0.0]: https://github.com/flutter/flutter/pull/153385
[Update tokens to v6.1.0]: https://github.com/flutter/flutter/pull/153722
[non-breaking]: https://github.com/flutter/flutter/flutter/blob/master/docs/contributing/Tree-hygiene.md#1-determine-if-your-change-is-a-breaking-change
