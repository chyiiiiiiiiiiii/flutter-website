...
[Issue #132504]: https://github.com/flutter/flutter/issues/132504#issuecomment-2025776552

## 背景

Android 14 推出了
[預測返回（Predictive Back）功能](https://developer.android.com/guide/navigation/predictive-back-gesture)，
...
### 支援預測返回（predictive back）
  ...
  1. 在 `android/app/src/main/AndroidManifest.xml` 中設定 `android:enableOnBackInvokedCallback="true"`。
      如有需要，請參考
     [Android 的完整指南](https://developer.android.com/guide/navigation/custom-back/predictive-back-gesture)
...
[`NavigatorPopHandler`]: https://api.flutter.dev/flutter/widgets/NavigatorPopHandler-class.html
[`PopEntry`]: https://api.flutter.dev/flutter/widgets/PopEntry-class.html
[`Form.canPop`]: https://api.flutter.dev/flutter/widgets/Form/canPop.html
[`Form.onPopInvoked`]: https://api.flutter.dev/flutter/widgets/Form/onPopInvoked.html
[`Route.popDisposition`]: https://api.flutter.dev/flutter/widgets/Route/popDisposition.html
[`ModalRoute.registerPopEntry`]: https://api.flutter.dev/flutter/widgets/ModalRoute/registerPopEntry.html
[`ModalRoute.unregisterPopEntry`]: https://api.flutter.dev/flutter/widgets/ModalRoute/unregisterPopEntry.html

[Issue 109513]: https://github.com/flutter/flutter/issues/109513
[Predictive back support for root routes]: https://github.com/flutter/flutter/pull/120385
[Platform channel for predictive back]: https://github.com/flutter/engine/pull/39208
