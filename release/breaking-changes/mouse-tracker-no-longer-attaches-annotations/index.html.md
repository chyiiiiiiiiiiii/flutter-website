# MouseTracker 不再附加註解（annotations）

> MouseTracker 現在不再依賴註解的附加來執行 mounted-exit 檢查； 因此，相關的三個方法已被移除。
...
以避免對已卸載的元件呼叫 `setState` 而導致例外（詳細說明請參見 [Issue #44631][]）。
...
[Improve MouseTracker lifecycle: Move checks to post-frame]: https://github.com/flutter/flutter/issues/44631
[Issue #44631]: https://github.com/flutter/flutter/pull/44631
...
[MouseTracker no longer requires annotations attached]: https://github.com/flutter/flutter/issues/48453
