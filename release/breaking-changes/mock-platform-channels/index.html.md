# 平台通道測試介面遷移至 flutter_test 套件

> 與 setMockMessageHandler 方法相關的 API 已從 package:flutter 遷移至 package:flutter_test
...
[`TestDefaultBinaryMessengerBinding`]: https://api.flutter.dev/flutter/flutter_test/TestDefaultBinaryMessengerBinding-mixin.html
