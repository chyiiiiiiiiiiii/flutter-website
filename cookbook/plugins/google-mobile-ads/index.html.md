...
> 如何使用 google_mobile_ads 套件在 Flutter 中顯示廣告。
...
若要使用 Ad Manager，請參考
[Ad Manager 文件](https://developers.google.com/ad-manager/mobile-ads-sdk/flutter/quick-start)。
:::
...
2.  為每個 AdMob 應用程式建立一個 *廣告單元（Ad unit）*。
    ...
    [AdMob 文件](https://developers.google.com/admob/flutter/quick-start)
    以及
