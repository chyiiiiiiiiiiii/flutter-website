...
更推薦直接建立一個
`StatelessWidget` 或 `StatefulWidget`，這樣效能更佳。更多相關考量可參考 [documentation](https://api.flutter.dev/flutter/widgets/StatelessWidget-class.html)
或 Flutter [YouTube channel](https://www.youtube.com/watch?v=IOyq-eTRhvo) 上的專屬影片。
