# 在 add-to-app 中管理插件與相依套件

> 學習如何在現有應用程式中使用插件，並共用你的 插件函式庫相依套件。
...
[ExoPlayer from the video_player plugin]: https://github.com/flutter/packages/blob/main/packages/video_player/video_player_android/android/build.gradle
[firebase_crashlytics]: https://pub.dev/packages/firebase_crashlytics
[Gradle file]: https://github.com/firebase/flutterfire/blob/bdb95fcacf7cf077d162d2f267eee54a8b0be3bc/packages/firebase_crashlytics/android/build.gradle#L40
