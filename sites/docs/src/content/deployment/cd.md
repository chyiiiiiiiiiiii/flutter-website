...
* [GitHub Actions][]
  * 範例：[GitHub Action in Flutter Project][]
* [Cirrus][]
* [Travis][]
* [GitLab][]
* [CircleCI][]
...
1. 設定程式碼簽章。
    * ![Android](/assets/images/docs/cd/android.png) 請參考 [Android app signing steps][]。
    * ![iOS](/assets/images/docs/cd/ios.png) 在 iOS 上，當你準備好使用 TestFlight 或 App Store 進行測試與部署時，請建立並使用發佈（distribution）憑證來簽署，而非開發（development）憑證。
        * 請在你的 [Apple Developer Account console][]
          建立並下載發佈憑證。
...
[Xcode Cloud][] 是一項持續整合與交付（CI/CD）服務，用於建置、
