---
title: DevTools 2.42.3 版本更新說明
shortTitle: 2.42.3 版本更新說明
breadcrumb: 2.42.3
description: Dart 與 Flutter DevTools 2.42.3 版本的更新說明。
showToc: false
---
...
* 降低 wasm 最佳化等級，以解決 dart2wasm 建置時的崩潰問題。- [#8814](https://github.com/flutter/devtools/pull/8814)
...
* 修正於新版檢查器中隱藏實作元件 (Widget) 時，在裝置上選取實作元件會顯示錯誤的問題。- [#8625](https://github.com/flutter/devtools/pull/8625)
