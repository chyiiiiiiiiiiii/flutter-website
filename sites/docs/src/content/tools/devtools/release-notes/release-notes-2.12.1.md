---
title: DevTools 2.12.1 版本發行說明
shortTitle: 2.12.1 版本發行說明
breadcrumb: 2.12.1
description: Dart 與 Flutter DevTools 2.12.1 版本的發行說明。
showToc: false
---

Dart 與 Flutter DevTools 2.12.1 版本
包含以下變更，以及其他一般性改進。
想進一步了解 DevTools，請參閱
...
* 在
  「Enhance Tracing」與「More debugging options」選單中新增了文件連結。
  請閱讀
