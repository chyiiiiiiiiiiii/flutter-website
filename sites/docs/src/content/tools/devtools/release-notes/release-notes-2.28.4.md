---
title: DevTools 2.28.4 版本發行說明
shortTitle: 2.28.4 版本發行說明
breadcrumb: 2.28.4
description: Dart 與 Flutter DevTools 2.28.4 版本的發行說明。
showToc: false
---

Dart 與 Flutter DevTools 2.28.4 版本
包含以下變更及其他一般性改進。
想進一步了解 DevTools，請參閱
[DevTools overview](https://docs.flutter.dev/tools/devtools)。

本次為基於 DevTools 2.28.3 的 cherry-pick 版本發行。
若想了解 DevTools 2.28.3 所包含的改進，請閱讀
...
* 修正一個錯誤，該錯誤導致由 Flutter 框架所擁有的元件 (Widget) 會顯示在元件樹檢視中 -
