---
title: DevTools 2.36.0 版本發行說明
shortTitle: 2.36.0 版本發行說明
breadcrumb: 2.36.0
description: Dart 與 Flutter DevTools 2.36.0 版本的發行說明。
showToc: false
---
...
* 新增顯示元件 (Widget) 建置次數的功能。
  啟用此設定後，您可以在「Frame Analysis」工具中
  查看每個 Flutter 畫格的元件 (Widget) 建置次數，或在全新的「Rebuild Stats」工具中
  查看這些次數的彙總統計資料。-
