---
title: DevTools 2.34.1 版本發行說明
shortTitle: 2.34.1 版本發行說明
breadcrumb: 2.34.1
description: Dart 和 Flutter DevTools 2.34.1 版本的發行說明。
showToc: false
---
...
- 修正了一個極端情境，導致其他套件的元件 (Widget) 可能出現在檢查器樹中。- [#7353](https://github.com/flutter/devtools/pull/7353)
