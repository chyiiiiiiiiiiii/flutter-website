...
這包含（但不限於）[VS Code][VS Code]、[Antigravity][Antigravity]、[Cursor][Cursor] 以及 [Windsurf][Windsurf]。
...
請依照下列步驟，使用 VS Code 來安裝與設定 Flutter。
 ...
 1. <h3>使用 VS Code 安裝 Flutter</h3>
    ...
    1. VS Code 會提示你在電腦上選擇 Flutter SDK 的位置。
       請選擇 **Download SDK**。
