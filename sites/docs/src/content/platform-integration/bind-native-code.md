---
title: 使用 FFI 綁定原生程式碼
description: 若要在 Flutter 程式中使用原生程式碼，請搭配 package_ffi 範本使用 dart:ffi 函式庫。
---
...
[`package:win32`]({{site.pub-pkg}}/win32) 和
[Canonical 的 Linux 套件]({{site.pub}}/publishers/canonical.com/packages)&mdash;請參閱
